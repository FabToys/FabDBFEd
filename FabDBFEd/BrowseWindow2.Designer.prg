...
//     Generator      : XSharp.CodeDomProvider 3.0.0.3
//     Timestamp      : 08/05/2026 11:16:28
//     
...
BEGIN NAMESPACE FabDBFEd
    PUBLIC PARTIAL CLASS BrowseWindow2 ;
        ...
        PRIVATE csvButton AS System.Windows.Forms.ToolStripButton
        ...
        /// </summary>
            ...
            SELF:csvButton := System.Windows.Forms.ToolStripButton{}
            ...
            SELF:toolStripBar:Items:AddRange(<System.Windows.Forms.ToolStripItem>{ SELF:topButton, SELF:leftButton, SELF:rightButton, SELF:bottomButton, SELF:toolStripSeparator1, SELF:appendButton, SELF:deleteButton, SELF:csvButton })
            SELF:toolStripBar:Location := System.Drawing.Point{0, 0}
            SELF:toolStripBar:Name := "toolStripBar"
            SELF:toolStripBar:Size := System.Drawing.Size{565, 31}
            ...
            SELF:topButton:Size := System.Drawing.Size{29, 28}
            ...
            SELF:leftButton:Size := System.Drawing.Size{29, 28}
            ...
            SELF:rightButton:Size := System.Drawing.Size{29, 28}
            ...
            SELF:bottomButton:Size := System.Drawing.Size{29, 28}
            ...
            SELF:toolStripSeparator1:Size := System.Drawing.Size{6, 31}
            // 
            // appendButton
            // 
            ...
            SELF:appendButton:Size := System.Drawing.Size{29, 28}
            ...
            SELF:deleteButton:Size := System.Drawing.Size{29, 28}
            SELF:deleteButton:Text := "Delete Record"
            SELF:deleteButton:Click += System.EventHandler{ SELF, @deleteButton_Click() }
            // 
            // csvButton
            // 
            SELF:csvButton:DisplayStyle := System.Windows.Forms.ToolStripItemDisplayStyle.Image
            SELF:csvButton:Image := ((System.Drawing.Image)(resources:GetObject("csvButton.Image")))
            SELF:csvButton:ImageTransparentColor := System.Drawing.Color.Magenta
            SELF:csvButton:Name := "csvButton"
            SELF:csvButton:Size := System.Drawing.Size{29, 28}
            SELF:csvButton:Text := "JSON Export"
            SELF:csvButton:Click += System.EventHandler{ SELF, @csvButton_Click() }
            // 
            // statusStripBar
            // 
            ...
            SELF:statusStripBar:Location := System.Drawing.Point{0, 297}
            SELF:statusStripBar:Name := "statusStripBar"
            SELF:statusStripBar:Padding := System.Windows.Forms.Padding{1, 0, 13, 0}
            SELF:statusStripBar:Size := System.Drawing.Size{565, 26}
            ...
            SELF:panel1:Location := System.Drawing.Point{0, 31}
            SELF:panel1:Margin := System.Windows.Forms.Padding{3, 2, 3, 2}
            SELF:panel1:Name := "panel1"
            SELF:panel1:Size := System.Drawing.Size{565, 266}
            ...
            SELF:dbfBrowseView:Size := System.Drawing.Size{565, 266}
