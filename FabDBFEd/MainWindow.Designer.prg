...
BEGIN NAMESPACE FabDBFEd
    PUBLIC PARTIAL CLASS Form1 ;
        ...
        PRIVATE METHOD InitializeComponent() AS VOID STRICT
            ...
            SELF:mainMenu:Location := System.Drawing.Point{0, 0}
            SELF:mainMenu:MdiWindowListItem := SELF:windowToolStripMenuItem
            SELF:mainMenu:Name := "mainMenu"
            SELF:mainMenu:Size := System.Drawing.Size{1083, 28}
            SELF:mainMenu:TabIndex := 0
            ...
            SELF:openToolStripMenuItem:ImageTransparentColor := System.Drawing.Color.Magenta
            SELF:openToolStripMenuItem:Name := "openToolStripMenuItem"
            SELF:openToolStripMenuItem:ShortcutKeys := ((System.Windows.Forms.Keys)((System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.O)))
            SELF:openToolStripMenuItem:Size := System.Drawing.Size{173, 26}
            ...
            SELF:toolStripSeparator1:Size := System.Drawing.Size{170, 6}
            // 
            // quitToolStripMenuItem
            // 
            SELF:quitToolStripMenuItem:Name := "quitToolStripMenuItem"
            SELF:quitToolStripMenuItem:Size := System.Drawing.Size{173, 26}
            ...
            SELF:viewToolStripMenuItem:Size := System.Drawing.Size{131, 26}
            ...
            SELF:windowToolStripMenuItem:Size := System.Drawing.Size{76, 24}
            SELF:windowToolStripMenuItem:Text := "Window"
            // 
            // cascadeToolStripMenuItem
            // 
            SELF:cascadeToolStripMenuItem:Name := "cascadeToolStripMenuItem"
            SELF:cascadeToolStripMenuItem:Size := System.Drawing.Size{172, 26}
            SELF:cascadeToolStripMenuItem:Text := "Cascade"
            ...
            SELF:tileVerticallyToolStripMenuItem:Size := System.Drawing.Size{172, 26}
            SELF:tileVerticallyToolStripMenuItem:Text := "Tile Vertically"
            ...
            SELF:toolStripButton1:Text := "Open Database"
            ...
            SELF:toolStripButtonReadOnly:ImageTransparentColor := System.Drawing.Color.Magenta
            SELF:toolStripButtonReadOnly:Name := "toolStripButtonReadOnly"
            SELF:toolStripButtonReadOnly:Size := System.Drawing.Size{97, 25}
            SELF:toolStripButtonReadOnly:Text := "ReadOnly"
